...
#' @param total String(s) used to name totals, passed to underlying functions.
#'              Named vectors or lists are supported. 
#'              See [FindDimLists()], [Formula2ModelMatrix()] and [AutoHierarchies()].
